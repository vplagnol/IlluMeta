pipeline=/ugi/data/sofia/Illumeta/scripts/pipeline.sh

input="/ugi/data/sofia/Illumeta/example/names_example.tab"    ################# Modify the sample names in the file
...
for sample in  `cat ${input}`; do
    ...
    prefix=/ugi/data/sofia/Illumeta/example/input_files/
    ...
    output=/ugi/data/sofia/Illumeta/example/results/                                                                                    ####### output Directory
    ...
    if [ ! -e /ugi/data/sofia/Illumeta/example/results/ ]; then mkdir /ugi/data/sofia/Illumeta/example/results/; fi
